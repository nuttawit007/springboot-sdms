...
const EditGradePage = () => {
    const { studentCode, subject } = useParams();
    ...
    useEffect(() => {
        getGradeByStudentCode(studentCode).then(data => {
            data.map(grade => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        updateGradeRecord(studentCode, subject, gradeData).then(() => {
            ...
            <div className="overflow-hidden rounded-xl border border-[#8FB3E2]/30 bg-white shadow-sm">
                ...
                <div className="border-b border-[#D9E1F1] bg-[#1E2E4F] px-6 py-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            Update grade information below
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-6">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="text" name="subject" value={gradeData.subject} onChange={handleChange} required className="rounded-lg border border-[#8FB3E2]/40 bg-white px-4 py-2.5 text-sm text-[#192338] placeholder-[#8FB3E2]/60 outline-none transition-colors focus:border-[#31487A] focus:ring-2 focus:ring-[#31487A]/20"/>
                    </div>
